...
alh_ave=0.0
alh_sqr=0.0
#three-ten_alh_sqr=0.0
#three-ten_alh_ave=0.0
dih_ave=0.0
dih_sqr=0.0
cga_ave=0.0
cga_sqr=0.0
...
for line in inf.readlines():
    ...
    alh_sqr+=prob*alh**2
    cnt5+=prob
    #three-ten_alh_sqr+=prob*three-ten_alh
    #three-ten_alh_ave+=prob*three-ten_alh**2
    #cnt9+=prob
    dih_ave+=prob*dih
    dih_sqr+=prob*dih**2
    cnt6+=prob
...
#three-ten_alh_ave/=cnt9
#three-ten_alh_sqr/=cnt9
#three-ten_std=numpy.sqrt(three-ten_alh_sqr-three-ten_alh_ave**2)
dih_ave/=cnt6
dih_sqr/=cnt6
...
## print out results
print "%8.3f %8.3f" % (rg_ave,rg_std)
print "%8.3f %8.3f" % (major_ave,major_std)
print "%8.3f %8.3f" % (median_ave,median_std)
print "%8.3f %8.3f" % (minor_ave,minor_std)
print "%8.3f %8.3f" % (alh_ave,alh_std)
#print "%8.3f %8.3f" % (three-ten_alh_ave,three-ten_alh_std)
print "%8.3f %8.3f" % (dih_ave,dih_std)
print "%8.3f %8.3f" % (cga_ave,cga_std)
print "%8.3f %8.3f" % (saltb_ave,saltb_std)